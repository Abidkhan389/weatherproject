    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<WeatherDBContext>(
                options=>options.UseSqlServer(Configuration.GetValue<string>("ConnectionString:WeatherDbConnection"))
                );
            services.AddScoped<IWeatherRepositroy,MockWeatherRepositroy>();
        }
